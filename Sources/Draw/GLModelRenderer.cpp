...
namespace spades {
	namespace draw {
		...
		void GLModelRenderer::RenderSunlightPassNoPlayers(bool ghostPass) {
			SPADES_MARK_FUNCTION();
			...
			for (RenderModel &m : models) {
				...
				m.model->RenderSunlightPass(params, ghostPass, false);
			}
		}
		...
		void GLModelRenderer::RenderSunlightPassVisiblePlayers(bool visiblePlayers[], bool ghostPass) {
			SPADES_MARK_FUNCTION();
			...
			for (RenderModel &m : models) {
				...
				m.model->RenderSunlightPass(params, ghostPass, true);
			}
		}
		void
